...
;(function(root, factory){
    ...
    FormValidator.prototype = {
        ...
        texts : {
            ...
            short           : 'o campo está muito pequeno',
            long            : 'o campo está muito grande',
            checked         : 'este campo deve ser checado',
            empty           : 'por favor preencha este campo',
            select          : 'Por favor selecione uma opção',
            number_min      : 'numero muito baixo',
            number_max      : 'numero muito alto',
            url             : 'URL inválida',
            number          : 'não é um número',
            email           : 'endereço de email não é válido',
            email_repeat    : 'endereços de email não são os mesmos',
            date            : 'data inválida',
            time            : 'hora inválida',
            password_repeat : 'a senhas não são as mesmas',
            no_match        : 'não encontrado',
            complete        : 'o campo não está completo'
        },
